...
/**
 * {@link SparseBooleanArray}s map integers to booleans. Unlike a normal array of
 * booleans there can be gaps in the indices. It is intended to be more memory
 * efficient than using a HashMap to map Integers to Booleans, both because it
...
public class SparseBooleanArray implements Cloneable {
	 ...
	 * If you supply an initial capacity of 0, the sparse array will be initialized
	 * with a light-weight representation not requiring any additional array
	 * allocations.
	 */
	...
	/**
	 * Gets the boolean mapped from the specified key, or <code>false</code> if no
	 ...
	 * the <code>index</code>th key-value mapping that this SparseBooleanArray
	 * stores.
	 *
	 * <p>
	 ...
	 * <code>keyAt(size()-1)</code> will return the largest key.
	 * </p>
	 */
	...
	/**
	 * Given an index in the range <code>0...size()-1</code>, returns the value from
	 * the <code>index</code>th key-value mapping that this SparseBooleanArray
	 * stores.
	 *
	 * <p>
	...
	/**
	 * Returns the index for which {@link #keyAt} would return the specified key, or
	 * a negative number if the specified key is not mapped.
	 */
