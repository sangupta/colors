...
/**
 * A class which allows custom selection of colors in a {@link Palette}'s
 * generation. Instances can be created via the {@link Builder} class.
 *
 * <p>
 * To use the target, use the {@link Palette.Builder#addTarget(Target)} API when
 * building a Palette.
 * </p>
 * 
 * @author sangupta
...
public final class Target {
	...
	/**
	 * A target which has the characteristics of a vibrant color which is light in
	 * luminance.
	 */
	...
	Target(Target from) {
		System.arraycopy(from.mSaturationTargets, 0, mSaturationTargets, 0, mSaturationTargets.length);
		System.arraycopy(from.mLightnessTargets, 0, mLightnessTargets, 0, mLightnessTargets.length);
	...
	/**
	 * Returns the weight of importance that this target places on a color's
	 * saturation within the image.
	 *
	 * <p>
	 * The larger the weight, relative to the other weights, the more important that
	 * a color being close to the target value has on selection.
	 * </p>
	 *
	...
	/**
	 * Returns the weight of importance that this target places on a color's
	 * population within the image.
	 *
	 * <p>
	 * The larger the weight, relative to the other weights, the more important that
	 * a color's population being close to the most populous has on selection.
	 * </p>
	 */
	...
	public final static class Builder {
		...
		/**
		 * Set the weight of importance that this target will place on saturation
		 * values.
		 *
		 * <p>
		 * The larger the weight, relative to the other weights, the more important that
		 ...
		 *
		 * <p>
		 * A weight of 0 means that it has no weight, and thus has no bearing on the
		 * selection.
		 * </p>
		 *
		...
		/**
		 * Set the weight of importance that this target will place on a color's
		 * population within the image.
		 *
		 * <p>
		 * The larger the weight, relative to the other weights, the more important that
		...
		/**
		 * Set whether any color selected for this target is exclusive to this target
		 * only. Defaults to true.
		 *
		 * @param exclusive true if any the color is exclusive to this target, or false
		 *                  is the color can be selected for other targets.
		 */
